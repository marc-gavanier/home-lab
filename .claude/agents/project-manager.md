...
- Work happens on feature branches; `main` is protected by a ruleset (PR + status checks + linear history; no signature rule, and rebase merges would strip signatures anyway); Renovate handles dependency PRs
